...
document.addEventListener('DOMContentLoaded', () => {
    ...
    var pwaScope = "/";
    var pwaLocation = "assets/service-worker.js";
    ...
    function init_template(){
        ...
        let menuHider = document.getElementsByClassName('menu-hider');
        let hider;// Se declara la variable hider aquí para evitar errores
        if(!menuHider.length){
            hider = document.createElement('div');
            hider.setAttribute("class", "menu-hider");
            document.body.insertAdjacentElement('beforebegin', hider);
        } else {
            hider = menuHider[0]; // Si ya existe, asigna el primer elemento encontrado
        }
